...
module.exports=React.createClass({
	render:function( ) {
		return(
				...
				<p><strong>Discuss Compensation</strong> Even though you may not want to give an exact compensation, give a range. Make sure to point out any bonuses, commissions, non-monetary compensation, as well.</p>
